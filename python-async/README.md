...
*PacsApi* | [**all_pacs_query_list**](docs/PacsApi.md#all_pacs_query_list) | **GET** /api/v1/pacs/queries/ | 
*PacsApi* | [**all_pacs_series_list**](docs/PacsApi.md#all_pacs_series_list) | **GET** /api/v1/pacs/series/ | 
...
*PacsApi* | [**pacs_list**](docs/PacsApi.md#pacs_list) | **GET** /api/v1/pacs/ | 
*PacsApi* | [**pacs_queries_create**](docs/PacsApi.md#pacs_queries_create) | **POST** /api/v1/pacs/{id}/queries/ | 
*PacsApi* | [**pacs_queries_destroy**](docs/PacsApi.md#pacs_queries_destroy) | **DELETE** /api/v1/pacs/queries/{id}/ | 
*PacsApi* | [**pacs_queries_retrieve**](docs/PacsApi.md#pacs_queries_retrieve) | **GET** /api/v1/pacs/queries/{id}/ | 
*PacsApi* | [**pacs_queries_retrieves_create**](docs/PacsApi.md#pacs_queries_retrieves_create) | **POST** /api/v1/pacs/queries/{id}/retrieves/ | 
*PacsApi* | [**pacs_queries_retrieves_destroy**](docs/PacsApi.md#pacs_queries_retrieves_destroy) | **DELETE** /api/v1/pacs/queries/retrieves/{id}/ | 
*PacsApi* | [**pacs_queries_retrieves_list**](docs/PacsApi.md#pacs_queries_retrieves_list) | **GET** /api/v1/pacs/queries/{id}/retrieves/ | 
*PacsApi* | [**pacs_queries_retrieves_retrieve**](docs/PacsApi.md#pacs_queries_retrieves_retrieve) | **GET** /api/v1/pacs/queries/retrieves/{id}/ | 
*PacsApi* | [**pacs_queries_retrieves_search_list**](docs/PacsApi.md#pacs_queries_retrieves_search_list) | **GET** /api/v1/pacs/queries/{id}/retrieves/search/ | 
*PacsApi* | [**pacs_queries_search_list**](docs/PacsApi.md#pacs_queries_search_list) | **GET** /api/v1/pacs/queries/search/ | 
*PacsApi* | [**pacs_queries_update**](docs/PacsApi.md#pacs_queries_update) | **PUT** /api/v1/pacs/queries/{id}/ | 
*PacsApi* | [**pacs_query_list**](docs/PacsApi.md#pacs_query_list) | **GET** /api/v1/pacs/{id}/queries/ | 
*PacsApi* | [**pacs_retrieve**](docs/PacsApi.md#pacs_retrieve) | **GET** /api/v1/pacs/{id}/ | 
*PacsApi* | [**pacs_search_list**](docs/PacsApi.md#pacs_search_list) | **GET** /api/v1/pacs/search/ | 
*PacsApi* | [**pacs_series_create**](docs/PacsApi.md#pacs_series_create) | **POST** /api/v1/pacs/series/ | 
*PacsApi* | [**pacs_series_destroy**](docs/PacsApi.md#pacs_series_destroy) | **DELETE** /api/v1/pacs/series/{id}/ | 
*PacsApi* | [**pacs_series_list**](docs/PacsApi.md#pacs_series_list) | **GET** /api/v1/pacs/{id}/series/ | 
...
## Documentation For Models
 ...
 - [DeletionStatusEnum](docs/DeletionStatusEnum.md)
 - [Feed](docs/Feed.md)
 ...
 - [PacsQueryStatus](docs/PacsQueryStatus.md)
 ...
 - [PaginatedPartialPluginInstanceList](docs/PaginatedPartialPluginInstanceList.md)
 ...
 - [PartialPluginInstance](docs/PartialPluginInstance.md)
 ...
 - [PluginInstanceStatus](docs/PluginInstanceStatus.md)
