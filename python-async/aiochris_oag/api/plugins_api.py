...
class PluginsApi:
    ...
    def _plugins_instances_search_list_serialize(
        ...
        if plugin_type is not None:
            ...
            _query_params.append(('plugin_type', plugin_type))
    ...
    async def plugins_metas_search_list(
        ...
        offset: Annotated[Optional[StrictInt], Field(description="The initial index from which to return the results.")] = None,
        public_repo: Optional[StrictStr] = None,
        title: Optional[StrictStr] = None,
    ...
    def _plugins_metas_search_list_serialize(
        ...
        if public_repo is not None:
            ...
            _query_params.append(('public_repo', public_repo))
