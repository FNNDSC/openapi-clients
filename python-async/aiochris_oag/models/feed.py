...
class Feed(BaseModel):
    ...
    copying_jobs: StrictInt = Field(description="Overriden to get the number of plugin instances in 'copying' status.")
    ...
    uploading_jobs: StrictInt = Field(description="Overriden to get the number of plugin instances in 'uploading' status.")
    ...
    owner: StrictStr
    __properties: ClassVar[List[str]] = ["url", "id", "creation_date", "modification_date", "name", "public", "owner_username", "folder_path", "created_jobs", "waiting_jobs", "copying_jobs", "scheduled_jobs", "started_jobs", "uploading_jobs", "registering_jobs", "finished_jobs", "errored_jobs", "cancelled_jobs", "deletion_status", "deletion_requested_at", "deletion_error", "folder", "note", "group_permissions", "user_permissions", "tags", "taggings", "comments", "plugin_instances", "owner"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "copying_jobs": obj.get("copying_jobs"),
            "scheduled_jobs": obj.get("scheduled_jobs"),
            "started_jobs": obj.get("started_jobs"),
            "uploading_jobs": obj.get("uploading_jobs"),
