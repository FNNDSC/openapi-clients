...
class FileBrowserFolder(BaseModel):
    ...
    owner: StrictStr
    __properties: ClassVar[List[str]] = ["url", "id", "creation_date", "path", "public", "owner_username", "deletion_status", "deletion_requested_at", "deletion_error", "parent", "children", "files", "link_files", "group_permissions", "user_permissions", "owner"]
