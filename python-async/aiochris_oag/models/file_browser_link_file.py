...
class FileBrowserLinkFile(BaseModel):
    ...
    linked_folder: Optional[StrictStr] = Field(default=None, description="Custom method to get the hyperlink to the linked folder if the ChRIS link points to a folder.")
    linked_file: Optional[StrictStr] = Field(default=None, description="Custom method to get the hyperlink to the linked file if the ChRIS link points to a file.")
