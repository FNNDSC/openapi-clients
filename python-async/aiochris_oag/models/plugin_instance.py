...
class PluginInstance(BaseModel):
    ...
    splits: StrictStr
    __properties: ClassVar[List[str]] = ["url", "id", "title", "previous_id", "compute_resource_name", "plugin_id", "plugin_name", "plugin_version", "plugin_type", "feed_id", "start_date", "end_date", "output_path", "status", "active", "pipeline_id", "pipeline_name", "workflow_id", "summary", "raw", "owner_username", "cpu_limit", "memory_limit", "number_of_workers", "gpu_limit", "size", "error_code", "deletion_status", "deletion_requested_at", "deletion_error", "previous", "output_folder", "feed", "plugin", "workflow", "compute_resource", "descendants", "parameters", "splits"]
