...
class PluginInstanceRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["title", "compute_resource_name", "cpu_limit", "memory_limit", "number_of_workers", "gpu_limit", "deletion_status", "deletion_requested_at", "deletion_error", "previous_id"]
