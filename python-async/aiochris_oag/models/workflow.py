...
class Workflow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "id", "creation_date", "title", "pipeline_id", "pipeline_name", "owner_username", "created_jobs", "waiting_jobs", "copying_jobs", "scheduled_jobs", "started_jobs", "uploading_jobs", "registering_jobs", "finished_jobs", "errored_jobs", "cancelled_jobs", "pipeline", "plugin_instances"]
