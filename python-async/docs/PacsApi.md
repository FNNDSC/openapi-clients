...
```python
import aiochris_oag
from aiochris_oag.models.paginated_pacs_query_list import PaginatedPACSQueryList
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.all_pacs_query_list(limit=limit, offset=offset)
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.all_pacs_series_list(limit=limit, offset=offset)
...
```python
import aiochris_oag
from aiochris_oag.models.paginated_pacs_list import PaginatedPACSList
from aiochris_oag.rest import ApiException
from pprint import pprint
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_list(limit=limit, offset=offset)
...
```python
import aiochris_oag
from aiochris_oag.models.pacs_query import PACSQuery
from aiochris_oag.models.pacs_query_request import PACSQueryRequest
from aiochris_oag.rest import ApiException
from pprint import pprint
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    api_instance = aiochris_oag.PacsApi(api_client)
    id = 56 # int | 
    pacs_query_request = aiochris_oag.PACSQueryRequest() # PACSQueryRequest |  (optional)

    try:
        api_response = await api_instance.pacs_queries_create(id, pacs_query_request=pacs_query_request)
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.pacs_queries_destroy(id)
    except Exception as e:
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_queries_retrieve(id)
...
```python
import aiochris_oag
from aiochris_oag.models.pacs_retrieve import PACSRetrieve
from aiochris_oag.rest import ApiException
from pprint import pprint
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_queries_retrieves_create(id)
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.pacs_queries_retrieves_destroy(id)
    except Exception as e:
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_queries_retrieves_list(id, limit=limit, offset=offset)
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_queries_retrieves_retrieve(id)
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_queries_retrieves_search_list(id, id2=id2, limit=limit, max_creation_date=max_creation_date, min_creation_date=min_creation_date, offset=offset, owner_username=owner_username, status=status)
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_queries_search_list(limit=limit, offset=offset)
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_queries_update(id, pacs_query_request=pacs_query_request)
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_query_list(id, limit=limit, offset=offset)
...
```python
import aiochris_oag
from aiochris_oag.models.pacs import PACS
from aiochris_oag.rest import ApiException
from pprint import pprint
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_retrieve(id)
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_search_list(active=active, id=id, identifier=identifier, limit=limit, offset=offset)
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = aiochris_oag.PacsApi(api_client)
    pacs_series_request = aiochris_oag.PACSSeriesRequest() # PACSSeriesRequest | 

    try:
        api_response = await api_instance.pacs_series_create(pacs_series_request)
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        await api_instance.pacs_series_destroy(id)
    except Exception as e:
...
async with aiochris_oag.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.pacs_series_list(id, limit=limit, offset=offset)
