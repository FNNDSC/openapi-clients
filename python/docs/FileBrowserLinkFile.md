...
**linked_folder** | **str** | Custom method to get the hyperlink to the linked folder if the ChRIS link points to a folder. | [optional] [readonly] 
**linked_file** | **str** | Custom method to get the hyperlink to the linked file if the ChRIS link points to a file. | [optional] [readonly] 
